...
for (let pet of pets) {
    ...
    div.innerHTML = `                <div class="shadow-sm p-3 border border-bordercolor rounded-lg">
                    <!-- image  -->
                    ...
                    <div class="my-3 flex justify-center my-3 border-t-2 pt-5 gap-4 ">
                        <button oneclick="" class="border rounded-lg py-1 px-2">
                        ...
                        <button onclick="details(event)" class="text-primary border px-2 py-1 rounded-lg">Details</button>
                    </div>
                </div>`
    parent.append(div);
    function details(event) {
        ...
        section.innerHTML = ` <div  id="details-card" class="hidden"></div>       <div class="fixed inset-0 z-10 bg-black bg-opacity-20 flex justify-center h-max">
            <div class="max-w-lg p-2 rounded-xl border border-bordercolor bg-white">
                ...
                <div class="my-3 ">
                    ...
                    <p class="my-3 text-gray-500 flex gap-2"><img
                            ...
                            id="date-of-birth">20-66-20</span></p>
                    ...
                    <p class="text-gray-500">${pet.pet_details}</p>
                       <div class="w-full mx-auto my-5"><button id="go-back"  class="py-2 px-4 rounded-lg text-primary w-full border">Go Back</button></div> 
                </div>
